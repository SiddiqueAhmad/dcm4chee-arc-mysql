FROM dcm4che/wildfly:ffmpeg-24.0.1-15.0.2
...
COPY deploy/dcm4chee-arc-ear-5.24.0-mysql.ear /docker-entrypoint.d/deployments/dcm4chee-arc-ear-5.24.0-mysql.ear
COPY setenv.sh /
